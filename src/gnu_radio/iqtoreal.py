...
class iqtoreal(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "iqtoreal")
        ...
        self.qtgui_time_sink_x_1_0_1.enable_tags(True)
        self.qtgui_time_sink_x_1_0_1.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "")
        self.qtgui_time_sink_x_1_0_1.enable_autoscale(True)
        ...
        self._qtgui_time_sink_x_1_0_1_win = sip.wrapinstance(self.qtgui_time_sink_x_1_0_1.qwidget(), Qt.QWidget)
        ...
        self.qtgui_eye_sink_x_1.set_samp_per_symbol(10)
        self.qtgui_eye_sink_x_1.set_y_axis(-1, 1)

        self.qtgui_eye_sink_x_1.set_y_label('Amplitude', "Before Symbol Sync")
        ...
        self.qtgui_eye_sink_x_1.enable_autoscale(True)
        ...
        self.qtgui_eye_sink_x_0.set_y_label('Amplitude', "After Symbol Sync")
        ...
        self.freq_xlating_fir_filter_xxx_0_0 = filter.freq_xlating_fir_filter_ccc(8, firdes.low_pass(1, samp_rate, 2.4e3, 240), 18.6e3, samp_rate)
        self.fec_async_decoder_0 = fec.async_decoder(viterbi, False, True, 641)
        self.digital_symbol_sync_xx_0 = digital.symbol_sync_cc(
            ...
            digital.IR_PFB_MF,
            32,
            firdes.root_raised_cosine(16, 16, 1.0/10.0, 0.35, 50))
        self.digital_fll_band_edge_cc_0 = digital.fll_band_edge_cc(10, 0.35, 100, 0.01309)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\joshb\\OneDrive\\Documents\\funcube recordings\\EMrecording2_20130922_194045Z_145941kHz_IQ (1).wav', True)
        ...
        # Connections
        ##################################################
        self.msg_connect((self.fec_async_decoder_0, 'out'), (self.satellites_ccsds_descrambler_0, 'in'))
        ...
        self.msg_connect((self.satellites_matrix_deinterleaver_soft_0, 'out'), (self.fec_async_decoder_0, 'in'))
        self.connect((self.blocks_complex_to_real_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.qtgui_time_sink_x_1_0_1, 0))
        self.connect((self.blocks_complex_to_real_0, 0), (self.satellites_distributed_syncframe_soft_0, 0))
        ...
        self.connect((self.digital_fll_band_edge_cc_0, 0), (self.qtgui_eye_sink_x_1, 0))
...
def main(top_block_cls=iqtoreal, options=None):
